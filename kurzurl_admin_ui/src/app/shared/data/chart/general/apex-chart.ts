...
import { padding } from "../../data/ui-kits/helper-class";
...
export let commonData1: ChartOptions | any = {
  series: [75],
  chart: {
    height: 180,
    type: "radialBar",
...
export let commonData2: ChartOptions | any = {
  series: [50],
  chart: {
    height: 110,
    type: "radialBar",
...
export let commonData3: ChartOptions | any = {
  series: [25],
  chart: {
    height: 110,
    type: "radialBar",
...
export let commonData4: ChartOptions | any = {
  series: [86],
  chart: {
    height: 110,
    type: "radialBar",
