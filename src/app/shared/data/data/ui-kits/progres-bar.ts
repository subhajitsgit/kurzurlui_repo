...
export const basicProgressBarData : progressBar[]= [
    {
...
export const stripedData : progressBar[] = [
    {
...
export const stripedAnimatedData : progressBar[] = [
    {
...
export const smallProgressBarData : progressBar[] = [
    {
...
export const largeProgressBarData : progressBar[] = [
    {
...
export const customHeightProgressBarData : progressBar[] = [
    {
